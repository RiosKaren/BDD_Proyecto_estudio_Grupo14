...
Cualquier desarrollador con los permisos adecuados para crear objetos en SQL Server puede definir un procedimiento almacenado. Además, SQL Server incluye cientos de procedimientos almacenados del sistema, identificados comúnmente por el prefijo 
